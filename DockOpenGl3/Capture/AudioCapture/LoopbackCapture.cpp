...
void CLoopbackCapture::ClearAudio()
{
    if (m_dwQueueID != 0)
    {
    ...
    return SetDeviceStateErrorIfFailed([&]()->HRESULT
        {
            ...
            hand = CreateFile(m_outputFileName, GENERIC_WRITE, 0, NULL, CREATE_ALWAYS, FILE_ATTRIBUTE_NORMAL, NULL);
            m_hFile.reset(hand);
